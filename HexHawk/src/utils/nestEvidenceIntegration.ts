...
export function buildNestEvidenceBundleFromSession(input: NestEvidenceBuildInput): NestEvidenceBundle {
  ...
  const bundle: NestEvidenceBundle = {
    ...
    final_verdict_snapshot: {
      ...
      negative_signals: finalVerdict.negativeSignals as unknown as import('../types/nestEvidence').JsonValue[],
      amplifiers: finalVerdict.amplifiers as unknown as import('../types/nestEvidence').JsonValue[],
      dismissals: finalVerdict.dismissals as unknown as import('../types/nestEvidence').JsonValue[],
      contradictions: finalVerdict.contradictions as unknown as import('../types/nestEvidence').JsonValue[],
      alternatives: finalVerdict.alternatives as unknown as import('../types/nestEvidence').JsonValue[],
      certainty_profile: {
